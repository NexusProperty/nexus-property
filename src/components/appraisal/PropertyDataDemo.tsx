...
const PropertyDetailsTab = ({ propertyData }: { propertyData: StandardizedPropertyData }) => (
  <Card>
    <CardHeader>
...
const ValuationTab = ({ propertyData }: { propertyData: StandardizedPropertyData }) => (
  <Card>
    <CardHeader>
...
const MarketDataTab = ({ propertyData }: { propertyData: StandardizedPropertyData }) => (
  <Card>
    <CardHeader>
...
const SalesHistoryTab = ({ propertyData }: { propertyData: StandardizedPropertyData }) => (
  <Card>
    <CardHeader>
...
const ComparablePropertyCard = ({ comparable }: { comparable: ComparableProperty }) => (
...
// Comparables tab component
const ComparablesTab = ({ propertyData }: { propertyData: StandardizedPropertyData }) => (
  <Card>
    <CardHeader>
        ...
        <div>
          ...
          <div className="space-y-4">
            {propertyData.comparables.comparables.map((comparable, index) => (
              <ComparablePropertyCard key={index} comparable={comparable} />
            ))}
          </div>
        </div>
      </div>
...
// Property data tabs component
const PropertyDataTabs = ({ propertyData }: { propertyData: StandardizedPropertyData }) => (
  <Tabs defaultValue="property" className="w-full">
    ...
    <TabsContent value="property">
      <PropertyDetailsTab propertyData={propertyData} />
    </TabsContent>
    
    <TabsContent value="valuation">
      <ValuationTab propertyData={propertyData} />
    </TabsContent>
    
    <TabsContent value="market">
      <MarketDataTab propertyData={propertyData} />
    </TabsContent>
    
    <TabsContent value="sales">
      <SalesHistoryTab propertyData={propertyData} />
    </TabsContent>
    
    <TabsContent value="comparables">
      <ComparablesTab propertyData={propertyData} />
    </TabsContent>
  </Tabs>
);
...
export function PropertyDataDemo() {
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      {propertyData && !isLoading && !error && <PropertyDataTabs propertyData={propertyData} />}
    </div>
  );
} 