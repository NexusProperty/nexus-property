          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              render={() => (
                <FormItem>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {["Garage", "Pool", "Fireplace", "Basement", "Deck", "Patio", "Garden", "Central Air", "Hardwood Floors", "Updated Kitchen"].map((feature) => (
                      <FormField
                        key={feature}
                        control={form.control}
                        name="features"
                        render={({ field }) => {
                          return (
                            ...
                            >
                              <FormControl>
                                <Checkbox
                                  checked={field.value?.includes(feature.toLowerCase().replace(/\s+/g, '_'))}
            ...
            <div className="flex justify-end space-x-4">
              ...
              <Button type="submit" disabled={isSubmitting}>
                {isSubmitting ? "Submitting..." : "Submit Appraisal Request"}
              </Button>
            </div>
          </form>
        </Form>
